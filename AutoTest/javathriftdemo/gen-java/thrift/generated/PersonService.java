...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2020-10-25")
public class PersonService {
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void recv_savePerson() throws DataException, org.apache.thrift.TException
    {
      ...
      if (result.dataExceptionw != null) {
        throw result.dataExceptionw;
      }
      return;
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class savePerson<I extends Iface> extends org.apache.thrift.ProcessFunction<I, savePerson_args> {
      ...
      public savePerson_result getResult(I iface, savePerson_args args) throws org.apache.thrift.TException {
        ...
        } catch (DataException dataExceptionw) {
          result.dataExceptionw = dataExceptionw;
        }
        return result;
      }
    }
      ...
      public AsyncMethodCallback<Void> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        ...
        return new AsyncMethodCallback<Void>() { 
          ...
          public void onError(Exception e) {
            ...
            savePerson_result result = new savePerson_result();
            if (e instanceof DataException) {
                        result.dataExceptionw = (DataException) e;
                        result.setDataExceptionwIsSet(true);
                        msg = result;
            }
             else 
            {
  ...
  public static class savePerson_result implements org.apache.thrift.TBase<savePerson_result, savePerson_result._Fields>, java.io.Serializable, Cloneable, Comparable<savePerson_result>   {
    ...
    private static final org.apache.thrift.protocol.TField DATA_EXCEPTIONW_FIELD_DESC = new org.apache.thrift.protocol.TField("dataExceptionw", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    ...
    public DataException dataExceptionw; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      DATA_EXCEPTIONW((short)1, "dataExceptionw");
      ...
      public static _Fields findByThriftId(int fieldId) {
        switch(fieldId) {
          case 1: // DATA_EXCEPTIONW
            return DATA_EXCEPTIONW;
          default:
            return null;
        }
      }
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.DATA_EXCEPTIONW, new org.apache.thrift.meta_data.FieldMetaData("dataExceptionw", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public savePerson_result(
      DataException dataExceptionw)
    {
      this();
      this.dataExceptionw = dataExceptionw;
    }
    ...
    public savePerson_result(savePerson_result other) {
      if (other.isSetDataExceptionw()) {
        this.dataExceptionw = new DataException(other.dataExceptionw);
      }
    }
    ...
    @Override
    public void clear() {
      this.dataExceptionw = null;
    }

    public DataException getDataExceptionw() {
      return this.dataExceptionw;
    }

    public savePerson_result setDataExceptionw(DataException dataExceptionw) {
      this.dataExceptionw = dataExceptionw;
      return this;
    }

    public void unsetDataExceptionw() {
      this.dataExceptionw = null;
    }

    /** Returns true if field dataExceptionw is set (has been assigned a value) and false otherwise */
    public boolean isSetDataExceptionw() {
      return this.dataExceptionw != null;
    }

    public void setDataExceptionwIsSet(boolean value) {
      if (!value) {
        this.dataExceptionw = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      switch (field) {
      case DATA_EXCEPTIONW:
        if (value == null) {
          unsetDataExceptionw();
        } else {
          setDataExceptionw((DataException)value);
        }
        break;
    ...
    public boolean equals(savePerson_result that) {
      ...
      boolean this_present_dataExceptionw = true && this.isSetDataExceptionw();
      boolean that_present_dataExceptionw = true && that.isSetDataExceptionw();
      if (this_present_dataExceptionw || that_present_dataExceptionw) {
        if (!(this_present_dataExceptionw && that_present_dataExceptionw))
          return false;
        if (!this.dataExceptionw.equals(that.dataExceptionw))
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_dataExceptionw = true && (isSetDataExceptionw());
      list.add(present_dataExceptionw);
      if (present_dataExceptionw)
        list.add(dataExceptionw);
    ...
    public int compareTo(savePerson_result other) {
      ...
      lastComparison = Boolean.valueOf(isSetDataExceptionw()).compareTo(other.isSetDataExceptionw());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetDataExceptionw()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dataExceptionw, other.dataExceptionw);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      sb.append("dataExceptionw:");
      if (this.dataExceptionw == null) {
        sb.append("null");
      } else {
        sb.append(this.dataExceptionw);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class savePerson_resultStandardScheme extends StandardScheme<savePerson_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, savePerson_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // DATA_EXCEPTIONW
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.dataExceptionw = new DataException();
                struct.dataExceptionw.read(iprot);
                struct.setDataExceptionwIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, savePerson_result struct) throws org.apache.thrift.TException {
        ...
        oprot.writeStructBegin(STRUCT_DESC);
        if (struct.dataExceptionw != null) {
          oprot.writeFieldBegin(DATA_EXCEPTIONW_FIELD_DESC);
          struct.dataExceptionw.write(oprot);
          oprot.writeFieldEnd();
        }
        oprot.writeFieldStop();
        oprot.writeStructEnd();
