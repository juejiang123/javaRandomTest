...
public class Person implements org.apache.thrift.TBase<Person, Person._Fields>, java.io.Serializable, Cloneable, Comparable<Person> {
  ...
  private static final org.apache.thrift.protocol.TField ISMARRIED_FIELD_DESC = new org.apache.thrift.protocol.TField("ismarried", org.apache.thrift.protocol.TType.BOOL, (short)3);
  ...
  private static final _Fields optionals[] = {_Fields.USERNAME,_Fields.AGE,_Fields.ISMARRIED};
  ...
  static {
    ...
    tmpMap.put(_Fields.ISMARRIED, new org.apache.thrift.meta_data.FieldMetaData("ismarried", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public void unsetIsmarried() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __ISMARRIED_ISSET_ID);
  }

  /** Returns true if field ismarried is set (has been assigned a value) and false otherwise */
  public boolean isSetIsmarried() {
    return EncodingUtils.testBit(__isset_bitfield, __ISMARRIED_ISSET_ID);
  }

  public void setIsmarriedIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __ISMARRIED_ISSET_ID, value);
  }
  ...
  public int hashCode() {
    ...
    boolean present_ismarried = true && (isSetIsmarried());
    list.add(present_ismarried);
    if (present_ismarried)
      list.add(ismarried);
  ...
  private static class PersonStandardScheme extends StandardScheme<Person> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Person struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetIsmarried()) {
        oprot.writeFieldBegin(ISMARRIED_FIELD_DESC);
